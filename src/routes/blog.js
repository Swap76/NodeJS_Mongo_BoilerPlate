...
router.post('/:id/upvote', IdValidator.isValidId, BlogValidator.blog, authController.checkUser, blogController.upvote);

router.post('/:id/downvote', IdValidator.isValidId, BlogValidator.blog, authController.checkUser, blogController.downvote);
